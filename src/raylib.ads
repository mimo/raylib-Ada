...
package raylib is
   ...
   package window is
      ...
      with Import => True, Convention => C, External_Name => "MaximizeWindow";

      --// Set window state: minimized, if resizable (only PLATFORM_DESKTOP)
      procedure minimize_window
      with Import => True, Convention => C, External_Name => "MinimizeWindow";

      --// Set window state: not minimized/maximized (only PLATFORM_DESKTOP)
      procedure restore_window
      with Import => True, Convention => C, External_Name => "RestoreWindow";

      --// Set icon for window (single image, RGBA 32bit, only PLATFORM_DESKTOP)
      procedure set_window_icon (icon_image : Image)
      with Import => True, Convention => C, External_Name => "SetWindowIcon";

      --// Set title for window (only PLATFORM_DESKTOP and PLATFORM_WEB)
      procedure set_window_title (title : String)
      with Import => True, Convention => C, External_Name => "SetWindowTitle";
      ...
      with Import => True, Convention => C, External_Name => "SetWindowSize";
      ...
      with Import => True, Convention => C, External_Name => "GetWindowHandle";
      ...
      with Import => True, Convention => C, External_Name => "GetRenderWidth";

      --// Get current render height (it considers HiDPI)
      function get_render_height return int
      with Import => True, Convention => C, External_Name => "GetRenderHeight";
      ...
      with Import => True, Convention => C, External_Name => "HideCursor";

      function is_cursor_hidden return Boolean;

      procedure enable_cursor
      with Import => True, Convention => C, External_Name => "EnableCursor";

      procedure disable_cursor
      with Import => True, Convention => C, External_Name => "DisableCursor";
      ...
      with Import => True, Convention => C, External_Name => "GetRandomValue";
      ...
      with Import => True, Convention => C, External_Name => "TakeScreenshot";

      --  RLAPI void SetConfigFlags(unsigned int flags);
      --// Setup init configuration flags (view FLAGS)
      procedure set_config_flags (flags : unsigned)
      with Import => True, Convention => C, External_Name => "SetConfigFlags";

      --  RLAPI void OpenURL(const char *url);
      --// Open URL with default system browser (if available)
      procedure open_URL (url : String)
      with Import => True, Convention => C, External_Name => "OpenURL";
   end window;
   ...
   package input is
      ...
      with Import => True, Convention => C, External_Name => "GetCharPressed";
      ...
      with Import => True, Convention => C, External_Name => "SetMouseCursor";
   end input;
   ...
   package rcamera is
      ...
      procedure update_pro
        (camera : access Camera3D; movement, rotation : Vector3; zoom : Float)
      with Import => True, Convention => C, External_Name => "UpdateCameraPro";
   ...
   package shapes is
      ...
      with Import => True, Convention => C, External_Name => "DrawLineBezier";
      ...
      with Import => True, Convention => C, External_Name => "DrawRectangleV";
      ...
      procedure draw_rectangle_rounded
        (rec : Rectangle; roundness : Float; segments : Integer; c : Color)
      with
        Import        => True,
        Convention    => C,
      ...
      procedure draw_triangle_fan
        (points : access Vector2; point_count : int; c : Color)
      with Import => True, Convention => C, External_Name => "DrawTriangleFan";
      ...
      with Import => True, Convention => C, External_Name => "GetCollisionRec";
   end shapes;
   ...
   package textures is
      ...
      procedure draw_texture_rec
        (texture   : Texture2D;
         ...
         position  : Vector2;
         tint      : Color)
      with Import => True, Convention => C, External_Name => "DrawTextureRec";
